...
// for android system.
INT LcxSmd_OpenSL_Open();								// Open the OpenSL Engine.
INT	LcxSmd_OpenSL_Close();								// close the OpenSL Engine.


// OpenAL Interface
INT LcxSmd_CreateALSoundFromFile(char* sCmd				// Create Sound Instance
...
INT LcxSmd_CreateALSoundFromMemory(char* sCmd			// Create Sound Instance
								, PLCX_SOUND* pOut		// Output instance
...
INT LcxSmd_CreateALSoundFromBuffer(char* sCmd			// Create Sound Instance
								, PLCX_SOUND* pOut		// Output instance
								, LC_HANDLE p1			// struct TLCX_SOUND_INF Address
								, LC_HANDLE p2 = NULL	// No Use
								, LC_HANDLE p3 = NULL	// No Use
...
// OpenSL Interface
INT LcxSmd_CreateSLSoundFromFile(char* sCmd				// Create Sound Instance
								, PLCX_SOUND* pOut		// Output instance
								, LC_HANDLE p1			// Sound File Name
								, LC_HANDLE p2 = NULL	// User Data(Option)
								, LC_HANDLE p3 = NULL	// No Use
...
INT LcxSmd_CreateSLSoundFromMemory(char* sCmd			// Create Sound Instance
								, PLCX_SOUND* pOut		// Output instance
...
INT LcxSmd_CreateSLSoundFromBuffer(char* sCmd				// Create Sound Instance
								, PLCX_SOUND* pOut		// Output instance
								, LC_HANDLE p1			// struct TLCX_SOUND_INF Address
								, LC_HANDLE p2 = NULL	// No Use
								, LC_HANDLE p3 = NULL	// No Use
...
#if defined(__ANDROID__) && defined(__OPENSL_ES__)
#define LcxSmd_DeviceOpen            LcxSmd_OpenSL_Open
#define LcxSmd_DeviceClose           LcxSmd_OpenSL_Close
#define LcxSmd_CreateSoundFromFile   LcxSmd_CreateSLSoundFromFile
#define LcxSmd_CreateSoundFromMemory LcxSmd_CreateSLSoundFromMemory
#define LcxSmd_CreateSoundFromBuffer LcxSmd_CreateSLSoundFromBuffer

#else
#define LcxSmd_DeviceOpen            LcxSmd_ALCDeviceOpen
#define LcxSmd_DeviceClose           LcxSmd_ALCDeviceClose
#define LcxSmd_CreateSoundFromFile   LcxSmd_CreateALSoundFromFile
#define LcxSmd_CreateSoundFromMemory LcxSmd_CreateALSoundFromMemory
#define LcxSmd_CreateSoundFromBuffer LcxSmd_CreateALSoundFromBuffer
