...
////////////////////////////////////////////////////////////////////////////////
// Interface for the LsxTsa class.
...
struct LsxTsa
{
	struct ILhLst
	{
		...
		LscH*	vLst[MAX_TSA];							// Tsa Instance
	...
	static INT	Lsc_Alloc(LC_HANDLE pL);				// Tsa file loading
	static INT	Lsc_Release(LC_HANDLE pL);				// Tsa file release
	static INT	Lsc_DrawOneFrame(LC_HANDLE pL);			// Tsa Select
