...
int main(int argc, char* argv[])
{
	...
	char* soundfile[] =
	{
		...
		(char*)MEDIA_DIR"sound/2.wav",
		(char*)MEDIA_DIR"sound/3.wav",
		(char*)MEDIA_DIR"sound/groove1.wav",
		(char*)MEDIA_DIR"sound/tsound1.wav",
		(char*)MEDIA_DIR"sound/mono.wav",
		(char*)MEDIA_DIR"sound/stereo.wav",
	};
